...
public class SAML2Assertion {
	...
	public static void main(String[] args) throws Exception {
		...
		saml.getCustomAttributes(plaintext);
	...
	public Map<String, String> getCustomAttributes(Element samlAssertion) {
		Map <String, String> customAttributes = new HashMap<String, String>();
		...
		for(int i=0; i<attributeList.getLength(); i++) {
			...
			for(int j=0; j<attributeValuesList.getLength(); j++) {
				...
				customAttributes.put(namedNodeMap.getNamedItem("Name").getNodeValue(),attributeValue.getTextContent());
			}
		}
