...
public class SAML2Assertion {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * Response response = saml.buildSAMLResponse(true, true,
		 * "ssridhar@apigee.com", saml.getAttributes(), publicKey, privateKey,
		 * certificate); saml.printResponse(response);
		 * 
		 * Assertion assertion =
		 * saml.decrypt(response.getEncryptedAssertions().get(0),
		 * privateKeyFile);
		 */
	...
	public BasicX509Credential getPublicKey(byte[] publiccert) throws Exception {
